...
export const MOCK_RESULTS: Record<string, AnalysisResponse> = {
  ...
  TEST: {
    ...
    score_breakdown: [
      { reason: '高含糖量與高升糖', description: '含有 29.2 公克添加糖，占每日建议攝取量之 58%', points: -7 },
      { reason: '熱量能量 (Calories)', description: '含有較多真空純化果糖能量負載', points: -3 },
    ],
    ingredients_detail: [
      {
        name: 'Dehydroacetic Acid (去水醋酸)',
        isAdditive: true,
        purpose: '防腐劑',
        description: '去水醋酸主要用於乾酪、起司限制防腐。茶飲類禁止使用。',
      ...
      },
      {
        ...
        isAdditive: true,
        purpose: '脂肪酸蔗糖酯乳化穩定劑',
        description: '食品加工優良用乳化劑。正常用量對健康無礙。',
        adiValue: '0 - 20 mg/kg body weight',
        iarcRating: '無危害安全評定',
        groupRisks: [],
      },
      {
        name: 'DL-Malic Acid (DL-蘋果酸)',
        isAdditive: true,
        purpose: '酸味劑 / 鮮果提味',
        description: '蘋果及核果中廣泛天然存在的有機酸。嬰兒食品禁用。',
        adiValue: '不限制',
        iarcRating: '無害分類',
        groupRisks: [],
      },
  ...
  '4710018123456': {
    ...
    ingredients_detail: [
      ...
      { name: '蔗糖', isAdditive: false, description: '高能量碳水化合物，過度食用易引起肥胖與牙齒蛀融。' },
      { name: '柳丁原汁', isAdditive: false, description: '提供橙果香味，含微量維生素C與微量果糖。' },
      { name: '柳橙濃縮汁', isAdditive: false, description: '真空低溫提純之濃縮柳橙漿，強化濃郁果香。' },
      {
        name: '麥芽糊精',
        isAdditive: true,
        purpose: '穩定劑與乾爽填充劑',
        description: '多用於增甜與風味載體，升糖指數(GI)偏高，糖尿病族群需審慎。',
        adiValue: '無限制',
        iarcRating: '未分類',
